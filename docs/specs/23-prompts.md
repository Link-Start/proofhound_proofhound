...
- Configuring **judgment rules**: declare "what kind of output counts as correct (a hit)" — e.g. "enum value matches certain values", "numeric value exceeds a threshold", "equals the expected output", etc.
