...
Run `pnpm release` to apply the pending changesets, update the root SemVer version, update `CHANGELOG.md`, run `pnpm run ci`, and commit the release artifacts as `chore(release): vX.Y.Z`.
